...
setopt menucomplete                                     # On an ambiguous completion, instead of listing possibilities or beeping, insert the first match immediately
...
zsh_add_file "command-not-found.zsh"
